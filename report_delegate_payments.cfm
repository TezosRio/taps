      ...
      <cfoutput query="#delegators_cycle_ordered#" group="cycle"> 
            ...
            <cfoutput>
               <tr>
                 ...
                 <td align="center" style="font-size:9pt;font-family:Courier;">#LSNumberFormat(delegators_cycle_ordered.total, '999,999,999,999.99')#</td>
               </tr>
            ...
            <tr>
               ...
               <td></td>
               <td align="center"></td>
               <td align="center" style="font-size:9pt;font-family:Courier;" >#LSNumberFormat(subtotalSum, '999,999,999,999.99')#&nbsp;XTZ</td>
            </tr>
         ...
         <table>
            ...
            <tr>
               ...
               <th></th>
               <th></th>
	       <th align="right" style="font-size:9pt;font-family:Courier;" >#LSNumberFormat(totalSum, '999,999,999,999.99')#&nbsp;XTZ</th>
            </tr>
